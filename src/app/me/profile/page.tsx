...
import { IoPersonCircle, IoMail, IoShieldCheckmark, IoTicket, IoReceipt, IoPencil, IoGift } from "react-icons/io5";
    ...
    <div className="min-h-screen bg-secondary py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted mt-2">Manage your personal information</p>
        </div>
          ...
          <div className="md:col-span-2 bg-tertiary rounded-2xl shadow-xl p-8">
            <div className="flex items-start justify-between mb-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted capitalize">{session.user.role}</p>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-xs text-muted/60 mt-1">Email cannot be changed</p>
              </div>
            ...
            <div className="bg-tertiary rounded-2xl shadow-xl p-6">
              <div className="flex items-center gap-3 mb-2">
                <div className="bg-accent1-primary/10 p-3 rounded-lg">
                  <IoTicket className="h-6 w-6 text-accent1-primary" />
                </div>
                <div>
                  <p className="text-2xl font-bold text-clear">0</p>
                  <p className="text-sm text-muted">Active Tickets</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-tertiary rounded-2xl shadow-xl p-6">
              <div className="flex items-center gap-3 mb-2">
                <div className="bg-accent2-primary/10 p-3 rounded-lg">
                  <IoReceipt className="h-6 w-6 text-accent2-primary" />
                </div>
                <div>
                  <p className="text-2xl font-bold text-clear">0</p>
